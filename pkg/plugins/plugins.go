...
func (pm *PluginManager) Init() error {
	...
	// ThingSPIN add code ------
	tsPlugDir := path.Join(setting.StaticRootPath, "app-thingspin-fms/plugins")
	if err := pm.scan(tsPlugDir); err != nil {
		return errutil.Wrapf(err, "Failed to scan main thingspin plugin directory '%s'", plugDir)
	}
	// ThingSPIN add code ------
